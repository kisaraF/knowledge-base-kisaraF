...
Tuples are immutable data structure type that looks similar to a list. It's great for use when you need to keep values of certain things immutable unlike in a list.

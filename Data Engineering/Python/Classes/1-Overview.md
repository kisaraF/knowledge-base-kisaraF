...
When programs grow in size and when you need to represent real world objects in code, the native data structures like strings, lists, etc. are not going to be sufficient. Hence, we would need our own data structures and a way to model these objects of real world into code. That's where OOP shines in.
